-- MySQL Script organizado e corrigido
...
-- -----------------------------------------------------
-- Table `casaoliveiradb`.`funcionario`produto
-- ----------------------produtoprodutoprodutoprodutoprodutoprodutoprodutoprodutoprodutoprodutoprodutoprodutoprodutoprodutoproduto-------------------------------
CREATE TABLE IF NOT EXISTS `casaoliveiradb`.`funcionario` (
  ...
  UNIQUE INDEX `certidao_nascimento_filho_UNIQUE` (`certidao_nascimento_filho`),
  UNIQUE INDEX `certidao_casamento_UNIQUE` (`certidao_casamento`),
  UNIQUE INDEX `certidao_reservista_UNIQUE` (`certidao_reservista`),
  UNIQUE INDEX `titulo_eleitor_UNIQUE` (`titulo_eleitor`),
  UNIQUE INDEX `telefone_funcionario_UNIQUE` (`telefone_funcionario`),
...
CREATE TABLE IF NOT EXISTS `casaoliveiradb`.`itens_venda` (
  ...
  INDEX `fk_itens_venda_produto1_idx` (`codigo_produto`),
